...
footer {
  ...
  --ve-foot-ul-background-color: var(--ani-sky-light);
  --ve-foot-title-margin-bottom: 5px;
  --ve-foot-title-font-size: 2rem;
  --ve-foot-title-font-family: var(--ani-monospace);
  --ve-foot-title-color: var(--ani-black);
  --ve-foot-section-a-color: var(--ani-black);
  --ve-foot-section-a-hover-color: var(--ani-slate);
}
