...
var _hoisted_2$7 = ["href", "id", "title"];
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.getBtnType() === 'button' ? (vue.openBlock(), vue.createElementBlock("button", {
    ...
    id: $props.id,
    title: $props.title
  }, [vue.renderSlot(_ctx.$slots, "btn"), vue.createTextVNode(" " + vue.toDisplayString($props.content), 1)], 8, _hoisted_2$7));
...
}var css_248z$9 = "\na[data-v-1f924cbe],\nbutton[data-v-1f924cbe] {\n  --btn-display: inline-block;\n  --btn-margin: 10px;\n  --btn-border: solid 2px var(--white);\n  --btn-border-radius: 10px;\n  --btn-padding: 5px 10px;\n  --btn-font-family: var(--monospace);\n  --btn-font-size: 1.2rem;\n  --btn-font-weight: bold;\n  --btn-text-align: center;\n  --btn-text-decoration: none;\n  --btn-background-color: var(--black);\n  --btn-color: var(--white);\n  --btn-cursor: pointer;\n\n  display: var(--btn-display);\n  margin: var(--btn-margin);\n  border: var(--btn-border);\n  border-radius: var(--btn-border-radius);\n  padding: var(--btn-padding);\n  font-family: var(--btn-font-family);\n  font-size: var(--btn-font-size);\n  font-weight: var(--btn-font-weight);\n  text-align: var(--btn-text-align);\n  text-decoration: var(--btn-text-decoration);\n  background-color: var(--btn-background-color);\n  color: var(--btn-color);\n  cursor: var(--btn-cursor);\n}\na[data-v-1f924cbe]:hover,\na[data-v-1f924cbe]:focus,\nbutton[data-v-1f924cbe]:hover,\nbutton[data-v-1f924cbe]:focus {\n  --btn-hover-border-color: var(--black);\n  --btn-hover-border-radius: 5px;\n  --btn-hover-background-color: var(--white);\n  --btn-hover-color: var(--black);\n  --btn-hover-box-shadow: inset 0 0 5px 2px;\n  --btn-hover-transition: all 200ms;\n\n  border-color: var(--btn-hover-border);\n  border-radius: var(--btn-hover-border-radius);\n  background-color: var(--btn-hover-background-color);\n  color: var(--btn-hover-color);\n  box-shadow: var(--btn-hover-box-shadow);\n  transition: var(--btn-hover-transition);\n}\na > *[data-v-1f924cbe],\nbutton > *[data-v-1f924cbe] {\n  --btn-child-display: block;\n  --btn-child-margin: auto;\n\n  display: var(--btn-child-display);\n  margin: var(--btn-child-margin);\n}\n\n/* RED */\n.btn-red[data-v-1f924cbe] {\n  background-color: var(--red);\n}\n.btn-red[data-v-1f924cbe]:hover,\n.btn-red[data-v-1f924cbe]:focus {\n  border-color: var(--red);\n  color: var(--red);\n}\n\n/* ORANGE */\n.btn-orange[data-v-1f924cbe] {\n  background-color: var(--orange);\n}\n.btn-orange[data-v-1f924cbe]:hover,\n.btn-orange[data-v-1f924cbe]:focus {\n  border-color: var(--orange);\n  color: var(--orange);\n}\n\n/* YELLOW */\n.btn-yellow[data-v-1f924cbe] {\n  background-color: var(--yellow);\n}\n.btn-yellow[data-v-1f924cbe]:hover,\n.btn-yellow[data-v-1f924cbe]:focus {\n  border-color: var(--yellow);\n  color: var(--yellow);\n}\n\n/* GREEN */\n.btn-green[data-v-1f924cbe] {\n  background-color: var(--green);\n}\n.btn-green[data-v-1f924cbe]:hover,\n.btn-green[data-v-1f924cbe]:focus {\n  border-color: var(--green);\n  color: var(--green);\n}\n\n/* SKY */\n.btn-sky[data-v-1f924cbe] {\n  background-color: var(--sky);\n}\n.btn-sky[data-v-1f924cbe]:hover,\n.btn-sky[data-v-1f924cbe]:focus {\n  border-color: var(--sky);\n  color: var(--sky);\n}\n\n/* BLUE */\n.btn-blue[data-v-1f924cbe] {\n  background-color: var(--blue);\n}\n.btn-blue[data-v-1f924cbe]:hover,\n.btn-blue[data-v-1f924cbe]:focus {\n  border-color: var(--blue);\n  color: var(--blue);\n}\n\n/* VIOLET */\n.btn-violet[data-v-1f924cbe] {\n  background-color: var(--violet);\n}\n.btn-violet[data-v-1f924cbe]:hover,\n.btn-violet[data-v-1f924cbe]:focus {\n  border-color: var(--violet);\n  color: var(--violet);\n}\n\n/* PINK */\n.btn-pink[data-v-1f924cbe] {\n  background-color: var(--pink);\n}\n.btn-pink[data-v-1f924cbe]:hover,\n.btn-pink[data-v-1f924cbe]:focus {\n  border-color: var(--pink);\n  color: var(--pink);\n}\n";
styleInject(css_248z$9);script$8.render = render$8;
script$8.__scopeId = "data-v-1f924cbe";var script$7 = {
  name: "FieldElt",
  props: {
    model: {
      prop: "value",
...
var _hoisted_3$6 = ["id", "max", "min", "name", "step", "type", "value", "required"];
var _hoisted_4$5 = ["id", "name", "type", "value", "required"];
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("fieldset", {
    ...
    required: $props.required
  }, null, 40, _hoisted_4$5)) : $options.getFieldType() === 'list' ? (vue.openBlock(), vue.createElementBlock("select", {
    key: 3,
    id: $props.id,
    name: $props.id,
...
var _hoisted_2$5 = ["src", "loop"];
var _hoisted_3$5 = ["src", "loop", "height", "width"];
var _hoisted_4$4 = ["src", "type"];
var _hoisted_5$3 = {
  key: 2
};
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("figure", {
    ...
    src: $props.src,
    loop: $props.loop
  }, [vue.renderSlot(_ctx.$slots, "audio")], 8, _hoisted_2$5)) : $props.type === 'video' ? (vue.openBlock(), vue.createElementBlock("video", {
    key: 1,
    controls: "",
    src: $props.src,
    loop: $props.loop,
  ...
  }), 128)), vue.renderSlot(_ctx.$slots, "video")], 8, _hoisted_3$5)) : $props.type === 'picture' ? (vue.openBlock(), vue.createElementBlock("picture", _hoisted_5$3, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.medias, function (picture, index) {
    return vue.openBlock(), vue.createElementBlock("source", {
      key: index,
      srcset: picture.src,
      media: picture.media,
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("ul", null, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, function (item, index) {
    ...
    }), $options.hasSlot('nested') ? (vue.openBlock(), vue.createElementBlock("ul", _hoisted_1$5, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(item, function (value, key) {
      return vue.openBlock(), vue.createElementBlock("li", {
        key: key
...
script$5.__scopeId = "data-v-341919e0";var script$4 = {
  ...
  return vue.pushScopeId("data-v-b545ecb8"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1$4 = {
  class: "slider"
};
...
var _hoisted_12 = /*#__PURE__*/_withScopeId$1(function () {
  return /*#__PURE__*/vue.createElementVNode("i", {
...
var _hoisted_15 = /*#__PURE__*/_withScopeId$1(function () {
  return /*#__PURE__*/vue.createElementVNode("i", {
    class: "fas fa-play fa-2x"
  }, null, -1);
});
var _hoisted_16 = [_hoisted_15];
var _hoisted_17 = /*#__PURE__*/_withScopeId$1(function () {
  return /*#__PURE__*/vue.createElementVNode("i", {
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("figure", _hoisted_1$4, [vue.createElementVNode("ul", _hoisted_2$4, [vue.createElementVNode("li", null, [vue.createElementVNode("button", {
    ...
    title: "Previous (←)"
  }, _hoisted_4$3)]), $props.random === true ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_5$2, [vue.createElementVNode("button", {
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return $options.checkRandom();
    }),
    id: "slider-random",
    title: "Normal"
  }, _hoisted_7$1)])) : (vue.openBlock(), vue.createElementBlock("li", _hoisted_8$1, [vue.createElementVNode("button", {
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $options.checkRandom();
    }),
    id: "slider-random",
    title: "Random"
  }, _hoisted_10$1)])), $props.auto === true ? (vue.openBlock(), vue.createElementBlock("li", _hoisted_11, [vue.createElementVNode("button", {
    onClick: _cache[3] || (_cache[3] = function ($event) {
      return $options.checkAuto();
    }),
    id: "slider-auto",
    title: "Pause"
  }, _hoisted_13)])) : (vue.openBlock(), vue.createElementBlock("li", _hoisted_14, [vue.createElementVNode("button", {
    onClick: _cache[4] || (_cache[4] = function ($event) {
      return $options.checkAuto();
    }),
    id: "slider-auto",
    title: "Play"
  }, _hoisted_16)])), vue.createElementVNode("li", null, [vue.createElementVNode("button", {
    onClick: _cache[5] || (_cache[5] = function ($event) {
      return $options.goNext();
    }),
    title: "Next"
  }, _hoisted_18)])]), vue.createElementVNode("ul", _hoisted_19, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.slides, function (slide, index) {
    return vue.openBlock(), vue.createElementBlock("li", {
      key: index,
      id: 'slide-' + (index + 1)
      ...
      slide: slide,
      index: index
    }), $options.hasSlot('info') ? (vue.openBlock(), vue.createElementBlock("figcaption", _hoisted_21, [vue.renderSlot(_ctx.$slots, "info", {
      slide: slide,
      index: index
    })])) : vue.createCommentVNode("", true)])], 8, _hoisted_20);
  }), 128))]), vue.createElementVNode("ul", _hoisted_22, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.slides, function (slide, index) {
    return vue.openBlock(), vue.createElementBlock("li", {
      key: index,
...
script$1.__scopeId = "data-v-040b655a";var script = {
  ...
  return vue.pushScopeId("data-v-38286c99"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1 = {
  key: 0,
  class: "sidebar"
