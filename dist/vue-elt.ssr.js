...
script$8.__scopeId = "data-v-4630a1ee";var script$7 = {
  name: "FieldElt",
  props: {
    model: {
      prop: "value",
...
var _hoisted_3$7 = ["type", "value", "min", "max", "required"];
var _hoisted_4$7 = ["type", "value", "required"];
var _hoisted_5$4 = ["placeholder", "required"];
var _hoisted_6$4 = ["value"];
var _hoisted_7$3 = {
  key: 1
};
var _hoisted_8$3 = ["value"];
var _hoisted_9$3 = ["value", "placeholder", "minlength", "maxlength", "cols", "rows", "required"];
var _hoisted_10$2 = ["type", "value", "placeholder", "minlength", "maxlength", "required"];
...
script$7.__scopeId = "data-v-f8b79834";var script$6 = {
  name: "MediaElt",
  props: {
    type: {
      type: String,
...
script$6.__scopeId = "data-v-61ebeeec";var script$5 = {
  name: "ListElt",
  props: {
    items: {
      type: Object,
...
script$1.__scopeId = "data-v-03ecf146";var script = {
  name: "NavElt",
  props: {
    class: {
      type: String,
  ...
  return vue.pushScopeId("data-v-7d195c1c"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1 = {
  key: 0,
  class: "sidebar"
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.getNavClass() === 'sidebar' ? (vue.openBlock(), vue.createElementBlock("nav", _hoisted_1, [vue.renderSlot(_ctx.$slots, "first"), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, function (item, index) {
    ...
    }), vue.createElementVNode("b", null, vue.toDisplayString(item.name), 1)], 8, _hoisted_7)]);
