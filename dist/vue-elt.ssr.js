...
var _hoisted_7$3 = ["value"];
var _hoisted_8$3 = {
  key: 2
};
var _hoisted_9$3 = ["index", "value"];
var _hoisted_10$2 = ["index", "value"];
var _hoisted_11$1 = ["id", "name", "value", "placeholder", "minlength", "maxlength", "cols", "rows", "itemprop", "required"];
var _hoisted_12$1 = ["type", "id", "name", "value", "placeholder", "minlength", "maxlength", "itemprop", "required"];
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("fieldset", {
    ...
    key: 0,
    value: $props.value
  }, vue.toDisplayString($props.content), 9, _hoisted_6$4)) : $props.value ? (vue.openBlock(), vue.createElementBlock("option", {
    key: 1,
    value: $props.value
  }, vue.toDisplayString($props.value), 9, _hoisted_7$3)) : (vue.openBlock(), vue.createElementBlock("option", _hoisted_8$3, vue.toDisplayString($props.info), 1)), $props.list[0].value ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
    key: 3
  }, vue.renderList($props.list, function (item, index) {
    return vue.openBlock(), vue.createElementBlock("option", {
      index: index,
      value: item.value
    }, vue.toDisplayString(item.content), 9, _hoisted_9$3);
  }), 256)) : (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
    key: 4
  }, vue.renderList($props.list, function (item, index) {
    return vue.openBlock(), vue.createElementBlock("option", {
      index: index,
      value: item
    }, vue.toDisplayString(item), 9, _hoisted_10$2);
  }), 256))], 40, _hoisted_5$5)) : $options.getFieldType() === 'area' ? (vue.openBlock(), vue.createElementBlock("textarea", {
    key: 4,
    id: $props.id,
    name: $props.name,
    value: $props.value,
    ...
    itemprop: $props.itemprop,
    required: $props.required
  }, null, 40, _hoisted_11$1)) : (vue.openBlock(), vue.createElementBlock("input", {
    key: 5,
    type: $props.type,
    id: $props.id,
    name: $props.name,
    ...
    itemprop: $props.itemprop,
    required: $props.required
  }, null, 40, _hoisted_12$1)), $options.hasSlot('label') ? (vue.openBlock(), vue.createElementBlock("label", {
    key: 6,
    for: $props.id
  }, [vue.renderSlot(_ctx.$slots, "label")], 8, _hoisted_13$1)) : vue.createCommentVNode("", true)], 8, _hoisted_1$7);
...
script$7.__scopeId = "data-v-0c6dd59e";var script$6 = {
  name: "MediaElt",
  props: {
    type: {
      type: String,
...
script$5.__scopeId = "data-v-4299fcd3";var script$4 = {
  name: "SliderElt",
  props: {
    slides: {
      type: Array
  ...
  return vue.pushScopeId("data-v-5bd2f0ca"), n = n(), vue.popScopeId(), n;
};
var _hoisted_1$4 = {
  class: "slider"
};
