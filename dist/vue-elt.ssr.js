...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("fieldset", {
    ...
    required: $props.required
  }, null, 40, _hoisted_4$7)) : $options.getFieldType() === 'list' && $props.content ? (vue.openBlock(), vue.createElementBlock("select", {
    key: 3,
    id: $props.id,
    name: $props.name,
...
script$7.__scopeId = "data-v-b77ee8de";var script$6 = {
  name: "MediaElt",
  props: {
    type: {
      type: String,
...
script$6.__scopeId = "data-v-aa01f9ee";var script$5 = {
  name: "ListElt",
  props: {
    items: {
      type: Object,
